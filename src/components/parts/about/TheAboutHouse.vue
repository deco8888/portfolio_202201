<template>
    <div :class="['p-about-house', { 'is-active': isShow }]" data-house>
        <nuxt-link to="/" class="p-about-house__link">
            <canvas class="p-about-house__canvas" data-canvas="house" ref="house"></canvas>
        </nuxt-link>
    </div>
</template>
